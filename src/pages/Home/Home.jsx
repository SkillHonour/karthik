    ...
    return (
        <div className="overallhome">
            ...
            <div className="homeheader">
                ...
                <h2>Innovation</h2>
                <p> Instead of relying on lectures or slides, he designs game-based and experiential formats that challenge participants to think, feel, and act differently.</p>
                <div className="homehead-btn">
                    <button>learn More</button>
                    <button>Explore workshop &nbsp; &rarr;</button>
                </div>
            ...
            <div className="homeourcompany">
                ...
                <button>Read our fully story &nbsp; &rarr;</button>
            </div>
            ...
            <div className="homefounder">
                ...
                <button>Learn More about Karthik &nbsp; &rarr;</button>
            </div>
            ...
            <div className="homeservicebtn">
                <button>Explore Our Service &nbsp; &rarr;</button>
            </div>
            ...
            <div className="homefooter">
                ...
                <div className="homefooter-btn">
                    <button>Get Started Today &nbsp; &rarr; </button>
